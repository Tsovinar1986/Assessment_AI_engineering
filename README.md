My assessment meant to make UI and the core vector using supabase for creating rag model for running a chat which contains:
1. PDF loading part using it to see the chunks how many chunk are there and see what it can do
2. the chat part where we write to make these odf file up to 20000 word handbook for AI engineering or to reply by main only creation.
